    ...
    <div>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='text-right'>
          <h2 className='text-lg capitalize font-medium'>vatsal</h2>
          <h4 className='text-xl font-semibold'>GJ03 AB 1234</h4>
          <p className='text-sm text-gray-600 capitalize'>Maruti Suzuki swift</p>
        </div>
      </div>
